...
document.addEventListener("DOMContentLoaded",async function(e){
    ...
    //     {
            ...
            //     cartInfo.articles=localStorageCart;
            //   }

            // Opcion 2
            // if (localStorageCart.find(product => product.id == cartInfo.articles[0].id)){
            //     cartInfo.articles=localStorageCart;
            //   }else{
            // for (const element of localStorageCart) {
            //     cartInfo.articles.push(element);
            // }}
